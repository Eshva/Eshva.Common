...
function addPreCommitMessageHook {
    ...
    # Например, EC-34 допустимо, а EC-34-precommit-hook недопустимо.
    # ВНИМАНИЕ: Данный скрипт написан для проекта (в Jira) EC. Если необходимо задействовать его для другого
